class StandardBpReading{
  static int MaximumSystolic=140;
  static int MaximumDiastolic=90;
  static int MinimumSystolic = 120;
  ...
  static int VeryLowSystolicMaxima=80;
  static int VeryLowDiastolicMaxima=50;
